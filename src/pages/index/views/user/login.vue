            ...
            <Card class="main">
                ...
                <Form ref="loginValidate" :model="loginValidate" :rules="ruleValidate" label-position="top"
                    ...
                    <Form-item label="账号：" prop="account">
                        <Input size="large" v-focus="true" v-model="loginValidate.account" @keyup.enter.native="handleSubmit('loginValidate')" clearable/>
                    </Form-item>
                    <Form-item label="密码：" prop="password">
                        <Input type="password" size="large" v-model="loginValidate.password" @keyup.enter.native="handleSubmit('loginValidate')" clearable/>
                    </Form-item>
...
export default {
    created() {
        ...
        //   if (key == 13) {
        //     app.handleSubmit('loginValidate');
        //   }
        // }
    },
    directives: {
